...
$sshCommand = "cd ~/affiliate-hub && git pull origin $Branch && cd bot && pip3 install -r requirements.txt && pkill -9 -f main.py; screen -w -dmS promo-bot python3 main.py; echo 'Robo reiniciado com Sucesso!'"
