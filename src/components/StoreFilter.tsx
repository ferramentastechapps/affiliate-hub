    ...
    <section className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-6">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
        {STORES.map((store) => (
          ...
          >
            <div className="w-5 h-5 rounded-full bg-white flex items-center justify-center overflow-hidden shrink-0 p-0.5">
              <img
            ...
            {activeStore === store.key && (
              <X size={12} weight="bold" className="text-zinc-400 ml-1" />
            )}
          </button>
        ))}
      </div>
