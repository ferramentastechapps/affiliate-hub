...
CATEGORY_KEYWORDS = {
    ...
    'Maquiagem e Pele': ['maquiagem', 'base facial', 'base liquida', 'base matte', 'base mate', 'base bastao', 'batom', 'rimel', 'protetor solar', 'skincare', 'hidratante rosto', 'creme anti-idade'],
